...
@section('header-actions')
    <a class="hubers-btn" href="{{ route('collaborators.create') }}">Krijo</a>
@endsection
@section('content')
    <div class="vms_panel">
        <form class="filter-items" action="{{ route('collaborators.index') }}" method="GET">
            ...
            <div class="hubers-filter-options @if ($is_on_search) active @endif">
                ...
                <div class="hubers-filter-list-actions">
                    ...
                    <a href="{{ route('collaborators.index') }}" class="hubers-btn inverse">Reset</a>
                </div>
            </div>
        </form>
                            ...
                            <td>
                             ...
                             <td>
                                <div class="bug-table-item-options">
                                    <a class="bug-table-item-option" href="{{route('collaborators.view',['id'=>$collaborator->id])}}">
                                        <i class="fa fa-eye"></i>
                                    </a>
        ...
        @else
            <div class="hubers-empty-tab">
                @if ($is_on_search)
                    <h5 class="text-center">Nuk ka bashkpuntor sipas search</h5>
                @else
                    <h5 class="text-center">Nuk ka bashkpuntor momentalisht</h5>
                @endif
            </div>
        @endif
    </div>
