    ...
    <div class="vms_panel">
        <form class="filter-items" action="/logs" method="GET" >
            <div class="filter-options">
                ...
                <div class="export-options" onclick="exportOptions.export('/logs/export','logs-export.xlsx')">
                ...
                <div class="hubers-filter-list-options">
                    ...
                    <div class="hubers-filter-group">
                        ...
                        <select class="hubers-select-input white medium" name="context" id="">
                            ...
                            <option @if(app('request')->input('context') == 12) selected @endif value="12">{{__('logs.filter.context.option.location')}}</option>
                        </select>
                    </div>
                    <div class="hubers-filter-group">
