...
@section('content')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="invoice_date" required class="bug-text-input" type="date"
                                        name="invoice_date">
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="discount_date" required class="bug-text-input" type="date"
                                        name="discount_date">
                                </div>
                            </div>
                            <div class="col-md-6">
    ...
    {{-- Koment --}}
    <div class="modal fade" id="reservationModalComment" tabindex="-1" role="dialog"
        aria-labelledby="reservationModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="reservationModalCommentLabel">Shto Koment</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <form role="form"  action="{{ route('reservations.comment.store', ['id' => $reservation->id]) }}" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="invoice_description" class="form-control-label">Komenti</label>
    ...
    <div class="modal fade" id="reservationModalMembers" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="reservationModalMembersLabel">Shto  Staff per kete Rezervim</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <form role="form"  action="{{ route('reservations.addMember', ['reservationId' => $reservation->id]) }}" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Selekto Staffin*</label>
                                     
                                        <select required id="userid" class="bug-text-input" name="user_id">
                                            <option value="">Selekto Staffin</option>
    ...
    <div class="vms_panel">
        ...
        <div style="width: 100%;">
            ...
            @else
                <div class="hubers-empty-tab">
                    <h5 class="text-center">Nuk ka Staff për këte rezervim.</h5>
                </div>
            @endif
        </div>
    </div>
