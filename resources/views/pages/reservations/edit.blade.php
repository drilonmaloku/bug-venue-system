        ...
        <div class="row">
            <div class="col-md-8">
                <form role="form" method="POST" action={{ route('reservations.update',['id'=> $reservation->id]) }} enctype="multipart/form-data" onsubmit="return disableSubmitButton();">
                    @csrf
                    @method('PUT')
                    <h6><strong>{{__('reservations.edit.reservation_information')}}</strong></h6>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="example-text-input" class="form-control-label">{{__('reservations.edit.date')}}*</label>
                    ...
                    <h6><strong>{{__('reservations.edit.client.information')}}:</strong></h6>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
