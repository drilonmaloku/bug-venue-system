                        ...
                        <tr>
                            ...
                            <td>
                                @if($guest->status == 1)
                                    ...
                                    <form
                                            action="{{ route('reservations-guests.updateGuestStatus', ['uuid' =>$reservation->id ,'guestId' => $guest->id]) }}"
                                            method="POST"
                                ...
                                @elseif($guest->status == 2)
                                    ...
                                    <form
                                            action="{{ route('reservations-guests.updateGuestStatus', ['uuid' =>$reservation->uuid ,'guestId' => $guest->id]) }}"
                                            method="POST"
                                            style="display: inline;"
                                    >
                                        @csrf
                            ...
                            <td>
                                <div class="bug-table-item-options">
                                    ...
                                    <form
                                            ...
                                            action="{{ route('reservations-guests.deleteGuest', ['uuid' => $reservation->uuid, 'guestId' => $guest->id]) }}"
                                            method="POST"
    ...
    <div class="modal fade" id="addGuestModal" tabindex="-1" role="dialog" aria-labelledby="reservationModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form role="form" method="POST" action="{{ route('reservations-guests.addGuest', ['uuid' => $reservation->uuid]) }}">
                    @csrf
        ...
        <div class="modal fade" id="editGuestModal{{$guest->id}}" tabindex="-1" role="dialog" aria-labelledby="editGuestModalLabel{{$guest->id}}" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form role="form" method="POST" action="{{ route('reservations-guests.updateGuest', ['uuid' => $reservation->id, 'guestId' => $guest->id]) }}">
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
                            <div class="row">
